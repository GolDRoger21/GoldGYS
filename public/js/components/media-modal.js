            ...
            if (mat.url.includes('spotify.com')) {
                ...
                if (videoId) {
                    ...
                    bodyEl.innerHTML = `
                        ...
                        .yt-progress-bar { flex: 1; -webkit-appearance: none; appearance: none; height: 6px; background: var(--border-color); border-radius: 4px; outline: none; cursor: pointer; }
                                        ...
                                        'onReady': (event) => {
                                            ...
                                            window.ytProgressInterval = setInterval(() => {
                                                if (window.currentYtPlayer && window.currentYtPlayer.getCurrentTime && typeof window.currentYtPlayer.getDuration === 'function') {
                                                    ...
                                                    if (dur > 0 && elProg) {
                                                        // Update visually filled part of the progress bar
